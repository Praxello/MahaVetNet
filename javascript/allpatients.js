...
function settabledata(styleData){
  ...
  for(let k of styleData.keys())
  {
        ...
        html +="<td>"+AllData.specie+"</td>";
        html +="<td>"+AllData.breed+"</td>";
        html +="<td>"+AllData.gender+"</td>";
        // html +="<td>"+AllData.specie+"/"+AllData.breed+"</td>";
        html +="<td>"+AllData.firstName+" "+AllData.lastName+"</td>";
        html +="<td><code>"+AllData.address+"</code></td>";
...
// console.log("Date2"+opddate);
var d = new Date(opddate);
$("#medicinetab").empty();
// console.log("Da"+d);
// var today=new date(opddate);
...
function savepage(){
  ...
  var feestype = $("#selpaymethod").val();
  var presentcondition = $("#selprecond").val();
  var samplenames = $("#selnoofsc").val();
