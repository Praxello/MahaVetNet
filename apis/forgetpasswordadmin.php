...
header('Content-Type: application/json');
  include "../connection.php";
	...
	{
		 $query = mysqli_query($conn,"select * from user_master_admin where email='$username' or mobile1= '$username'");
			if($query!=null)
			{
...
$to      = $result['email'];
$subject = 'Password recovery from SMART PRO';
...
:solid 1px #ccc; width:600px;">
        ...
        <tr>
            <td align="left" valign="top" style="padding-left:20px; padding-top:10px; color:#363636; padding-bottom:15px; line-height:12px; font-size:14px; padding-right:20px; font-family:Arial, Helvetica, sans-serif;">
                Your password for SmartPro application is : '.$result['password'].'
            </td>
        </tr>
        ...
        <tr>
                <td align="left" valign="top" style="padding:10px 15px; background:#3B4851; font-family:Arial, Helvetica, sans-serif; color:#fff; font-size:14px;">&copy; '.date("Y").' SmartPto app All rights reserved</td>
              </tr>
    </table>
</body>
</html>';
