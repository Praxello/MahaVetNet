...
if(isset($_POST['branchid'])){
    $sql = "SELECT SUM(animalCount) animalCount,SUM(tagged) tagged,SUM(farmercount) farmercount,SUM(Total) Total,SUM(downloads) downloads,SUM(vd) vd,SUM(revenue) revenue FROM(
