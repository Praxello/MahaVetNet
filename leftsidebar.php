  ...
  <aside class="sidebar-left">
    <nav class="navbar navbar-inverse">
        <div class="navbar-header">
          ...
          <h1><a class="navbar-brand" href="#"><span class="dashboard_text">MahaVetNet</span></a></h1>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="sidebar-menu">
            ...
            <li><a href="vaccination.php"><i class="fa fa-angle-right text-red"></i> <span>Vaccination</span></a></li>
            <li><a href="deworming.php"><i class="fa fa-angle-right text-yellow"></i> <span>Deworming</span></a></li>
