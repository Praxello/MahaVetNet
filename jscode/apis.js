             ...
             success: function(response) {
                 if (response.Data != null) {
                     ...
                     for (var i = 0; i < count; i++) {
                         ...
                         tblData += '<p><span>' + response.Data[i].mobile + '(' + response.Data[i].branchId + ')</span></p><a class="btn btn-success btn-sm float-right" type="button" onclick="getanemail(\'' + response.Data[i].branchId + '\',\'' + response.Data[i].centre_type + '\',\'' + response.Data[i].mobile + '\')";>Confirm VD</a> </div><div class="clearfix"></div> </a>';
                         tblData += '</li>';
                     }
                     tblData += '<hr></hr>';
