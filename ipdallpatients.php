              ...
              <div class="col_3">
                  ...
                  <div class="col-md-3">
                    <div class="r3_counter_box">
                            ...
                            <div class="col-sm-6">
                            <img id="setnavanimal" src='http://praxello.com/ahimsa/animalphotos/0.jpg'class="rounded-circle" style="width: 40px;height: 45px;" alt="No Img" onclick="imgon(this.src);"></img>
                            </div>
                            <div class="col-sm-6">
                            <div class="stats">
                    ...
                    <div id="collapseSix" class="collapse " aria-labelledby="headingSix" data-parent="#accordion">
                      <div class="card-body ">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group">
                            <label class="control-label">Bull Number</label>
                            <input type="text" class="form-control" id="pdstrawno" placeholder="Enter Bull Number" required>
