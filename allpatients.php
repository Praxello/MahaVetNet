...
<body class="cbp-spmenu-push">
    ...
    <input type="hidden"  id="drid" value="<?php echo $drid ;?>"/>
                  ...
                  <div class="col-md-3 widget widget1">
                    <div class="r3_counter_box">
                            ...
                            <div class="stats">
                              ...
                              <h5><div id="opdanimalname"></div></h5>
                            </div>
                        </div>
                  </div>
                  <div class="col-md-3 widget widget1">
                    <div class="r3_counter_box">
                            <i class="pull-left fa fa-empty user2 icon-rounded"></i>
                            <div class="stats">
                              <span><strong>Species/Breed</strong></span>
                              <h5><div id="opdanimalage"></div></h5>
                            </div>
                        </div>
                  </div>
                  <div class="col-md-3 widget widget1">
                    <div class="r3_counter_box">
                            <i class="pull-left fa fa-empty dollar1 icon-rounded"></i>
                            <div class="stats">
                      ...
                      <div class="card-body ">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group">
                            ...
                            <input type="file" id="animalimgname" alt="no Image" required/>
                          </div>
                          </div>
                        </div>
                        <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-sm-4">
          <button type="button" class="btn btn-success" style="width: 100%;background-color: blue;" onclick="savepage();">SAVE</button>
          </div>
